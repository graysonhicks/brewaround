...
app.get('/api', function(req, res){
  ...
  request('https://api.brewerydb.com/v2/search/geo/point?lat=' + lat + '&lng=' + lng + '&type=beer&hasLabel=Y&key=72a751214ab8b53056ac0a6d8376dc2d', function (error, response, body) {
